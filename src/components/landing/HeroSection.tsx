  ...
  return <section className="relative overflow-hidden" aria-labelledby="hero-heading">
      ...
      <div className="container py-12 md:py-24 lg:py-32 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 id="hero-heading" className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold text-foreground mb-4 md:mb-6 animate-slide-up leading-tight">
          ...
          {/* Subtitle */}
          <p className="text-lg md:text-2xl text-muted-foreground mb-8 md:mb-10 max-w-2xl mx-auto animate-slide-up px-2" style={{
          animationDelay: '0.1s'
        }}>Vi gør din iPhone, iPad & Mac nem at forstå.</p>
